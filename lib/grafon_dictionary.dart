...
final _demoGroup = WordGroup(
  ...
  [
    ...
    CoreWord(Quads.Curve.right.mix(Quads.Curve.down), "Leaf"),
    ...
    CoreWord(Mono.Light.wrap(Quads.Curve.right.mix(Quads.Curve.down)), "Green",
        "Color of leaf."),
...
final _interpersonalGroup = WordGroup(
  ...
  [
    ...
    CoreWord(Mono.Dot.next(Mono.Empty.gram).over(Quads.Corner.up), "You",
        "Second person singular pronoun."),
    CoreWord(Mono.Empty.next(Mono.Dot.gram).over(Quads.Corner.right),
